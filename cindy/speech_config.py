...
# Neural voice — en-AU-NatashaNeural is a natural Australian English voice.
# The photoreal TTS Avatar service is only available in West US 2, West Europe,
# and Southeast Asia; for Australian presenters Southeast Asia (Singapore) is
# the closest supported region.  An Australian-accented voice pairs naturally
# with that deployment.
AZURE_TTS_VOICE: str = os.getenv("AZURE_TTS_VOICE", "en-AU-NatashaNeural")
